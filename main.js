...
var AppComponent = /** @class */ (function () {
    function AppComponent(markdownService, http) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('assets/markdown/communist-manifesto.md', { responseType: 'text' }).subscribe(function (data) {
            console.log(data);
            _this.text = data;
        });
    };
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ngx_markdown__WEBPACK_IMPORTED_MODULE_1__["MarkdownService"],
